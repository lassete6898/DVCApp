...
contract InvestmentsContract {
    ...
    function createInvestment(string memory _title, string memory _description) public {
        investmentCounter++;
        investments[investmentCounter] = Investment(investmentCounter, _title, _description, true, block.timestamp);
        emit InvestmentCreated(investmentCounter, _title, _description, true, block.timestamp);
    }
